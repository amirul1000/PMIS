...
?>
<script language="javascript" src="rest_of_recreation.js"></script>
	               				 ...
	               				 <table class="table">
                                       <tr>
                                                  <td>  
                                                     ...
                                                     <form name="frm_rest_of_recreation" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
                                                      <div class="portlet-body">
                                                     <div class="table-responsive">	
                                                        <table class="table">
                                                            <tr>
                                         ...
                                         <tr>
                                             <td>Coming Date</td>
                                             <td>
                                                <input type="text" name="coming_date" id="coming_date"  value="<?=$coming_date?>" class="textbox">
                                                <a href="javascript:void(0);" onclick="displayDatePicker('coming_date');"><img src="../../images/calendar.gif" width="16" height="16" border="0" /></a>
                                             </td>
                                         </tr>
										 <tr> 
											 <td align="right"></td>
