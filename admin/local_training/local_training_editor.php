...
?>
<script language="javascript" src="local_training.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_local_training" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										<tr>
                                         ...
                                         <td>Institition</td>
                                         <td>
                                            <input type="text" name="institition" id="institition"  value="<?=$institition?>" class="textbox">
                                         </td>
                                     </tr><tr>
                                         <td>from_</td>
                                         <td>
