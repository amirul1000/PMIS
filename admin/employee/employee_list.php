							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							 <td>
							  ...
							  <td nowrap >
								...
								?> 
                                  <?php
								 if($_SESSION["roles"]['archive']== "archive")
								 {
                                ?> 
                                  <a href="index.php?cmd=archive&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to archive this item ?');"><i class="fa fa-times"></i>send to archive</a> 
                                  <?php
								 }
								?> 
