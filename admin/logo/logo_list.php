...
?>
<a href="index.php?cmd=edit" class="btn green">Add a logo</a> <br><br>
 <div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","logo"))?></b>
                </div>
                <div class="tools">
				                ...
				                <table class="table">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_logo" >
