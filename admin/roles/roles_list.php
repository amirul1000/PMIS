...
<a href="index.php?cmd=edit" class="btn green">Add a role</a>
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
				  ...
				  <a href="index.php?cmd=delete&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs black"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-trash-o"></i>Delete</a> 
			 </td>
